...
const SchoolHighlights = props => {
    ...
    const renderCoursesInList = (data, index, handleChange) => {
        return (
            <EdInput style={{ width: "100%", marginBottom: 8 }} key={index} />
        );
    };
        ...
        <React.Fragment>
            ...
            <Card style={{ marginTop: 30 }}>
                <CardContent>
                    ...
                    <h4 className={style.card_sub_title}>
                        {t(
                            "General description of the all the planned activities "
                        )}
                    </h4>
                    <EdInput
                        rows={6}
