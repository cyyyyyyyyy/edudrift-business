  ...
  return (
    <React.Fragment>
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          <h3 className={style.card_title}>{t("Grading Policies")}</h3>
      ...
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          ...
          <h4 className={style.card_sub_title}>{t("Course Availability")}</h4>
          <EdInput
            rows={6}
            placeholder={t(
              "E.g. The grading system follows a bell-curve based on the performances of students within the selected course(s)."
            ...
            style={{ width: "100%", height: 120 }}
          />
          <h4 className={style.card_sub_title}>{t("Course Changes")}</h4>
          <EdInput
            rows={6}
            placeholder={t(
              "E.g. The grading system follows a bell-curve based on the performances of students within the selected course(s)."
            ...
            style={{ width: "100%", height: 120 }}
          />
          <h4 className={style.card_sub_title}>{t("Course Withdrawal")}</h4>
          <EdInput
            rows={6}
            placeholder={t(
              "E.g. The grading system follows a bell-curve based on the performances of students within the selected course(s)."
      ...
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          <h3 className={style.card_title}>{t("Program Withdrawal")}</h3>
          <p className={style.card_text}>
            {t(
