...
const SchoolSchedule = props => {
  ...
  return (
    <React.Fragment>
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          ...
          <Grid container style={{ paddingTop: 10 }}>
            ...
            <Grid item xs={3}>
              <EdDatePick
                onSelect={val => handleDatePick("schedule_early_register", val)}
          ...
          <h4 className={style.card_sub_title}>
            {t("Standard Registration Deadline for Online Application")}
          </h4>
          <p className={style.card_text}>
            {t("The standardised deadline to process all applications.")}
          </p>
          <Grid container style={{ paddingTop: 10 }}>
            <Grid item xs={2}>
              {t("Register by")}
      ...
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          <h3 className={style.card_title}>{t("Other Important Dates")}</h3>
          <p className={style.card_text}>
            {t(
      ...
      <Card style={{ marginTop: 30 }}>
        <CardContent>
          <h3 className={style.card_title}>{t("Program Schedule")}</h3>
          <p className={style.card_text}>
            {t("The complete rundown of your summer/winter program")}
          </p>
          <Grid container>
            <Grid item xs={2}>
              {t("Start Date")}
          ...
          <Grid container style={{ paddingTop: 8 }}>
            ...
            <Grid item xs={5}>
              <p className={style.card_text}>
                {t("Participants should arrive before this date")}
              </p>
            </Grid>
          </Grid>
          <h4 className={style.card_sub_title}>
